...
import { Plus, Loader2, Handshake, ExternalLink, ArrowRight, Building2, User, Phone, Mail, Layers } from 'lucide-react'
  ...
  const { data: allDeliverables = [], isLoading: deliverablesLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select('id, name, platform, quantity, unit, deadline, status, deal_id, deals!inner(id, title, nama_campaign, workspace_id, brand_id, brands(name, nama_brand))')
